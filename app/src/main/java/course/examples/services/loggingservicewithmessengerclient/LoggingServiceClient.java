...
public class LoggingServiceClient extends Activity {
    ...
    private final static String SERVICE_PACKAGE_NAME =
            "course.examples.services.loggingservicewithmessenger";
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mLoggingServiceIntent.setPackage(SERVICE_PACKAGE_NAME);
